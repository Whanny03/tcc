...
urlpatterns = [
    ...
    path('ver/<int:id>/', view_news_two, name='view_news_two'),
    ...
    path('view/<int:id>/', view_news_3, name='view_news_3'),
    ...
    path('lista_tutorias_diretor/', lista_tutorias_diretor, name='lista_tutorias_diretor'),
    path('mais_historia/', mais_historia, name='mais_historia')
